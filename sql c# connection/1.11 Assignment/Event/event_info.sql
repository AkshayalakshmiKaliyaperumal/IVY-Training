...
insert into event values('Anniversary','October','Priya','Chennai',150000)
...
insert into event values('Party','September','Madhu','Hyderabad',200000)
insert into event values('Anniversary','November','Asha','Hyderabad',200000)
